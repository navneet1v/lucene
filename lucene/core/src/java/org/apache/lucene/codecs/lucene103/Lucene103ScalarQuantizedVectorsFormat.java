 ...
 * </ul>
 */
public class Lucene103ScalarQuantizedVectorsFormat extends FlatVectorsFormat {
  public static final String QUANTIZED_VECTOR_COMPONENT = "QVEC";
  public static final String NAME = "Lucene103ScalarQuantizedVectorsFormat";

  static final int VERSION_START = 0;
  static final int VERSION_CURRENT = VERSION_START;
  static final String META_CODEC_NAME = "Lucene103ScalarQuantizedVectorsFormatMeta";
  static final String VECTOR_DATA_CODEC_NAME = "Lucene103ScalarQuantizedVectorsFormatData";
  ...
  private static final Lucene103ScalarQuantizedVectorScorer scorer =
      new Lucene103ScalarQuantizedVectorScorer(FlatVectorScorerUtil.getLucene99FlatVectorsScorer());
  ...
  public Lucene103ScalarQuantizedVectorsFormat() {
    this(ScalarEncoding.UNSIGNED_BYTE);
  }

  /** Creates a new instance with the chosen quantization encoding. */
  public Lucene103ScalarQuantizedVectorsFormat(ScalarEncoding encoding) {
    super(NAME);
  ...
  public String toString() {
    return "Lucene103ScalarQuantizedVectorsFormat(name="
        + NAME
        + ", encoding="
        + encoding
        + ", flatVectorScorer="
