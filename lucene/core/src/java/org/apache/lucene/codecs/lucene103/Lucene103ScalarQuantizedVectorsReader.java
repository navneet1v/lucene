...
import static org.apache.lucene.codecs.lucene103.Lucene103ScalarQuantizedVectorsFormat.VECTOR_DATA_EXTENSION;
...
public class Lucene103ScalarQuantizedVectorsReader extends FlatVectorsReader
    implements QuantizedVectorsReader {

  private static final long SHALLOW_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(Lucene103ScalarQuantizedVectorsReader.class);

  private final Map<String, FieldEntry> fields = new HashMap<>();
  private final IndexInput quantizedVectorData;
  private final FlatVectorsReader rawVectorsReader;
  private final Lucene103ScalarQuantizedVectorScorer vectorScorer;
  public static final int EXHAUSTIVE_BULK_SCORE_ORDS = 64;

  /** Sole constructor */
  public Lucene103ScalarQuantizedVectorsReader(
      ...
      try {
        versionMeta =
            CodecUtil.checkIndexHeader(
                ...
                Lucene103ScalarQuantizedVectorsFormat.VERSION_START,
