 ...
 * TestLucene103ScalarQuantizedVectorsFormat.simulateEmptyRawVectors()}.
 *
 * @lucene.internal
 */
abstract class OffHeapScalarQuantizedFloatVectorValues extends FloatVectorValues
  ...
  final Lucene103ScalarQuantizedVectorsFormat.ScalarEncoding encoding;
  ...
  OffHeapScalarQuantizedFloatVectorValues(
      ...
      int size,
      float[] centroid,
      Lucene103ScalarQuantizedVectorsFormat.ScalarEncoding encoding,
  ...
  private static class EmptyOffHeapVectorValues extends OffHeapScalarQuantizedFloatVectorValues {
    EmptyOffHeapVectorValues(
      ...
      super(
          ...
          0,
          null,
          Lucene103ScalarQuantizedVectorsFormat.ScalarEncoding.UNSIGNED_BYTE,
          similarityFunction,
          vectorsScorer,
          null);
    }
