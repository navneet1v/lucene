 ...
 * @lucene.experimental
 */
public class Lucene103ScalarQuantizedVectorScorer implements FlatVectorsScorer {
  private final FlatVectorsScorer nonQuantizedDelegate;

  public Lucene103ScalarQuantizedVectorScorer(FlatVectorsScorer nonQuantizedDelegate) {
  ...
  public RandomVectorScorer getRandomVectorScorer(
    ...
    if (vectorValues instanceof QuantizedByteVectorValues qv) {
      ...
      Lucene103ScalarQuantizedVectorsFormat.ScalarEncoding scalarEncoding = qv.getScalarEncoding();
      ...
      // scoring comparisons
      if (scalarEncoding
              == Lucene103ScalarQuantizedVectorsFormat.ScalarEncoding.SINGLE_BIT_QUERY_NIBBLE
          || scalarEncoding
              == Lucene103ScalarQuantizedVectorsFormat.ScalarEncoding.DIBIT_QUERY_NIBBLE) {
  ...
  public String toString() {
    return "Lucene103ScalarQuantizedVectorScorer(nonQuantizedDelegate="
