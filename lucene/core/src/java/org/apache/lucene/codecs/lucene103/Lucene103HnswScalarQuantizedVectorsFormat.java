 ...
 * quantized using {@link Lucene103ScalarQuantizedVectorsFormat} before being stored in the graph.
 */
public class Lucene103HnswScalarQuantizedVectorsFormat extends KnnVectorsFormat {

  public static final String NAME = "Lucene103HnswBinaryQuantizedVectorsFormat";
  ...
  private final Lucene103ScalarQuantizedVectorsFormat flatVectorsFormat;
  ...
  public Lucene103HnswScalarQuantizedVectorsFormat() {
    this(
   ...
   */
  public Lucene103HnswScalarQuantizedVectorsFormat(int maxConn, int beamWidth) {
    this(
        ScalarEncoding.UNSIGNED_BYTE,
        maxConn,
        beamWidth,
  ...
  public Lucene103HnswScalarQuantizedVectorsFormat(
    ...
    super(NAME);
    flatVectorsFormat = new Lucene103ScalarQuantizedVectorsFormat(encoding);
  ...
  public String toString() {
    return "Lucene103HnswScalarQuantizedVectorsFormat(name=Lucene103HnswScalarQuantizedVectorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ", tinySegmentsThreshold="
