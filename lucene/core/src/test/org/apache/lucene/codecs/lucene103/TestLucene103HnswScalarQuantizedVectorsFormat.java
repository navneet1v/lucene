...
public class TestLucene103HnswScalarQuantizedVectorsFormat extends BaseKnnVectorsFormatTestCase {
  ...
  public void setUp() throws Exception {
    ...
    format =
        new Lucene103HnswScalarQuantizedVectorsFormat(
            encoding,
            Lucene99HnswVectorsFormat.DEFAULT_MAX_CONN,
            Lucene99HnswVectorsFormat.DEFAULT_BEAM_WIDTH,
            1,
            null,
            0); // Disable tiny segment threshold for testing
    super.setUp();
  }
    ...
    FilterCodec customCodec =
        new FilterCodec("foo", Codec.getDefault()) {
          ...
          public KnnVectorsFormat knnVectorsFormat() {
            return new Lucene103HnswScalarQuantizedVectorsFormat(
                ScalarEncoding.UNSIGNED_BYTE, 10, 20, 1, null);
          }
        };
    String expectedPattern =
        "Lucene103HnswScalarQuantizedVectorsFormat(name=Lucene103HnswScalarQuantizedVectorsFormat,"
            + " maxConn=10, beamWidth=20, tinySegmentsThreshold=100,"
            + " flatVectorFormat=Lucene103ScalarQuantizedVectorsFormat(name=Lucene103ScalarQuantizedVectorsFormat,"
            + " encoding=UNSIGNED_BYTE,"
            + " flatVectorScorer=Lucene103ScalarQuantizedVectorScorer(nonQuantizedDelegate=%s()),"
  ...
  public void testLimits() {
    expectThrows(
        ...
        () -> new Lucene103HnswScalarQuantizedVectorsFormat(-1, 20));
    expectThrows(
        IllegalArgumentException.class, () -> new Lucene103HnswScalarQuantizedVectorsFormat(0, 20));
    expectThrows(
        IllegalArgumentException.class, () -> new Lucene103HnswScalarQuantizedVectorsFormat(20, 0));
    expectThrows(
        IllegalArgumentException.class,
        () -> new Lucene103HnswScalarQuantizedVectorsFormat(20, -1));
    expectThrows(
        IllegalArgumentException.class,
        () -> new Lucene103HnswScalarQuantizedVectorsFormat(512 + 1, 20));
    expectThrows(
        IllegalArgumentException.class,
        () -> new Lucene103HnswScalarQuantizedVectorsFormat(20, 3201));
    expectThrows(
        IllegalArgumentException.class,
        () ->
            new Lucene103HnswScalarQuantizedVectorsFormat(
