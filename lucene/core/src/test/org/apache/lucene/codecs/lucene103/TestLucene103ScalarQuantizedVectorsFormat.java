...
public class TestLucene103ScalarQuantizedVectorsFormat extends BaseKnnVectorsFormatTestCase {
  ...
  public void setUp() throws Exception {
    ...
    format = new Lucene103ScalarQuantizedVectorsFormat(encoding);
    super.setUp();
  }
    ...
    FilterCodec customCodec =
        new FilterCodec("foo", Codec.getDefault()) {
          ...
          public KnnVectorsFormat knnVectorsFormat() {
            return new Lucene103ScalarQuantizedVectorsFormat();
          }
        };
    String expectedPattern =
        "Lucene103ScalarQuantizedVectorsFormat("
            + "name=Lucene103ScalarQuantizedVectorsFormat, "
      ...
      try (IndexWriter w = new IndexWriter(dir, newIndexWriterConfig())) {
        ...
        try (IndexReader reader = DirectoryReader.open(w)) {
          ...
          QuantizedByteVectorValues qvectorValues =
              ((Lucene103ScalarQuantizedVectorsReader.ScalarQuantizedVectorValues) vectorValues)
          ...
          if (similarityFunction == VectorSimilarityFunction.COSINE) {
            vectorValues =
                new Lucene103ScalarQuantizedVectorsWriter.NormalizedFloatVectorValues(vectorValues);
          }
